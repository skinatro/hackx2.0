...
// ── Reusable inline styles for icon badges ──────────────────────────────────
...
// ── Content that sits ON the cube face (text, not panels) ────────────────────

const headerContent: ReactNode = (
    <div style={{
        display: "flex", flexDirection: "column", alignItems: "center",
        justifyContent: "center", width: "100%", height: "100%", gap: 8, padding: "0 32px",
        textAlign: "center"
    }}>
        <p style={{
        ...
        <h1 style={{
            fontSize: "clamp(28px, 4vw, 52px)", fontWeight: 900, margin: 0,
        ...
        <p style={{
            fontSize: "clamp(12px, 1.2vw, 16px)", color: "rgba(148,163,184,0.9)",
...
const contactInfoContent: ReactNode = (
    <div style={{
        ...
        padding: "20px 24px", gap: 16, boxSizing: "border-box"
    }}>
        <p style={{
        ...
        <div style={row}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <span style={{
                    fontSize: "clamp(11px, 1vw, 14px)", color: "#e2e8f0",
                    fontWeight: 500
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <a
                    ...
                    style={{
                        ...
                        fontWeight: 500, lineHeight: 1.6, textDecoration: "none",
                        pointerEvents: "auto"
                    }}
                >
...
const sendMessageContent: ReactNode = (
    <div style={{
        display: "flex", flexDirection: "column", width: "100%", height: "100%",
        padding: "20px 24px", gap: 12, boxSizing: "border-box"
    }}>
        <p style={{
...
const contactLayout: Parameters<typeof WaveTiles>[0]["cubeLayout"] = [
    ...
    {
        // Send Message — tall right block (equal width)
        row: 6,
        col: 15,
        rowSpan: 16,
        colSpan: 10,
...
export default function ContactPage() {
    return <WaveTiles cubeLayout={contactLayout} />;
}
